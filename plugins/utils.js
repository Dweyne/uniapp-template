...
// #endif
/*补0*/
export const fillZero = function(val) {
 ...
 * 题型映射
 */
export const mapType = function(val) {
	let title = ''
	switch (val) {
		case 1:
			title = '单选题'
...
export const replaceInput = function(val){
	val = val.replace(/\<input.*?\/>/g, '<u>&emsp;&emsp;&emsp;&emsp;</u>')
	return val
}
