...
const mainPagePath = ['pages/index/index', 'pages/my/my', 'pages/demo/common', 'pages/template/common', 'pages/apiDemo/common'];
//返回首页的地址
const homePath = '/pages/index/index';
//白色表达值
const whiteList = ['#FFF', '#fff', '#FFFFFF', '#ffffff', 'white', 'rgb(255,255,255)', 'rgba(255,255,255,1)', '#E0E0E0'];
export default {
	props: {
		//是否显示返回按钮
		// 1000 显示返回按钮
	...
	data() {
		return {
			...
			navBgColor: '',
			//透明底字体色
			navTransparentFixedFontColor: '#2f2f2f',
			// 导航栏高度
			statusBarHeight: 0,
			// 上次显示的导航栏颜色
			lastFrontColor: '',
